...
@section('title'){{ $postCate->name ?? 'Tin tức và hoạt động' }} - {{ $config->web_title }}@endsection
                ...
                <section class="right-content col-lg-9 col-lg-push-3">
                    ...
                    <style>
                        ...
                        .news_home_content_short_title a {
                            ...
                            overflow: hidden;
                            text-overflow: ellipsis;
                            line-height: 1.3em;         /* điều chỉnh cho phù hợp */
                            max-height: calc(1.3em * 2);
                        }

                        /* Mô tả (intro) chỉ 3 dòng */
                        .news_home_content_short_info {
                            display: -webkit-box;
                            -webkit-box-orient: vertical;
                            ...
                            overflow: hidden;
                            text-overflow: ellipsis;
                            line-height: 1.4em;         /* điều chỉnh cho phù hợp */
                            max-height: calc(1.4em * 3);
                        }
