...
Route::group(['namespace' => 'Front'], function () {
    ...
    Route::get('/dich-vu','FrontController@getServices')->name('front.getServices');
    Route::get('/dich-vu/{slug}','FrontController@getServiceDetail')->name('front.getServiceDetail');
    Route::get('/danh-muc/{slug}','FrontController@getPostCategory')->name('front.getPostCategory');
    Route::get('/post/{slug}','FrontController@getPostDetail')->name('front.getPostDetail');
    Route::get('/ve-chung-toi','FrontController@about_page')->name('front.about_page');
    Route::get('/tim-kiem','FrontController@searchs')->name('front.searchs');
