		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
                ...
                <fieldset class="border p-3 mb-3">
                    <legend class="w-auto px-2" style="font-size: 18px">Thông tin chủ sở hữu</legend>

                    <div class="form-group custom-group">
                        <label class="form-label">Tên chủ sở hữu</label>
                        <input class="form-control" ng-model="form.chusohuu" type="text">
                    </div>

                    <div class="form-group custom-group">
                        <label class="form-label">Địa chỉ</label>
                        <input class="form-control" ng-model="form.diachi" type="text">
                    </div>

                    <div class="form-group custom-group">
                        <label class="form-label">Điện thoại</label>
                        <input class="form-control" ng-model="form.dienthoai" type="text">
                    </div>

                    <div class="form-group custom-group">
                        <label class="form-label">Số giấy chứng nhận đăng ký kinh doanh</label>
                        <input class="form-control" ng-model="form.sodkkd" type="text">
                    </div>

                    <div class="form-group custom-group">
                        <label class="form-label">Nơi cấp</label>
                        <input class="form-control" ng-model="form.noicap" type="text">
                    </div>
                </fieldset>
{{--				<div class="form-group custom-group">--}}
