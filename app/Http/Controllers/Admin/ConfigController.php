...
class ConfigController extends Controller
{
	...
	public function update(Request $request)
	{
		...
		try {
			...
			$object->chusohuu = $request->chusohuu;
			$object->diachi = $request->diachi;
			$object->dienthoai = $request->dienthoai;
			$object->sodkkd = $request->sodkkd;
			$object->noicap = $request->noicap;
