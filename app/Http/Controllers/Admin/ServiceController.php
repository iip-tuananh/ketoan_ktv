    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->editColumn('image', function ($object) {
                return '<img style ="max-width:85px !important" src="' . ($object->image->path ?? '') . '"/>';
            })
...
//            'cate_id' => 'required',
            ...
            'image_back' => 'required|file|mimes:jpg,jpeg,png|max:2000',
...
//            'cate_id' => 'required',
            ...
            'image_back' => 'nullable|file|mimes:jpg,jpeg,png|max:2000',
            'galleries' => 'nullable|array|min:1|max:20',
            'galleries.*.image' => 'nullable|file|mimes:png,jpg,jpeg|max:10000',
        ];
